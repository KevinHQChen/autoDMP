...
E = 2.97 * ut.MPa;     % Young's modulus for PDMS (usually 1.32 to 2.97 MPa)
k_aq = E*A_aq/l_aq;
K_aq = rho_aq * (1500 * ut.m/ut.s)^2; % bulk modulus estimate
C_aq = A_aq / k_aq + l_aq / K_aq;
% C_aq = unitConvert(C_aq, ut.um / ut.mbar); % units of C should be um/mbar
