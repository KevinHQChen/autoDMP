...
class SupervisoryController final
{
 ...
 public:
  ...
  struct DW {
    ...
    real_T y0_i[3];                    // '<Root>/SupervisoryController'
    real_T u0_i[3];                    // '<Root>/SupervisoryController'
    real_T umax_o[3];                  // '<Root>/SupervisoryController'
    real_T uwt_d[3];                   // '<Root>/SupervisoryController'
    real_T r__f[3];                    // '<Root>/SupervisoryController'
    real_T y__m[3];                    // '<Root>/SupervisoryController'
    real_T y0_a[3];                    // '<Root>/SupervisoryController'
    real_T x0_f[2];                    // '<Root>/SupervisoryController'
    real_T u0_ig[3];                   // '<Root>/SupervisoryController'
    real_T umax_d[3];                  // '<Root>/SupervisoryController'
    real_T uwt_k[3];                   // '<Root>/SupervisoryController'
    ...
    real_T Product3_n[18];             // '<S86>/Product3'
    ...
    real_T last_mv_DSTATE_m[3];        // '<S13>/last_mv'
    ...
    real_T x0_a;                       // '<Root>/SupervisoryController'
    ...
    boolean_T Memory_PreviousInput_j[246];// '<S13>/Memory'
    boolean_T integratorRST;           // '<Root>/SupervisoryController'
    boolean_T integratorRST_o;         // '<Root>/SupervisoryController'
    ...
    boolean_T icLoad_k;                // '<S43>/MemoryX'
    boolean_T icLoad_j;                // '<S43>/MemoryP'
 ...
 private:
  ...
  boolean_T any_d(const real_T x[3]);
